...
const Teams = () => {
  return (
    ...
    lg:px-24 xl:px-40 pt-30 text-gray-800 dark:text-white'>
      ...
      {/* we have a teamData array in our assets.js */}
...

      {
        teamData.map((person , index)=>{
            return (
                ...
                key={index} className='flex max-sm:flex-col
                items-center gap-5 p-4 rounded-xl border border-gray-100
                dark:border-gray-700 bg-white dark:bg-gray-900
                shadow-xl shadow-gray-100 dark:shadow-white/5
                hover:scale-103 transition-all duration-400'>

                    <img src={person.image} className='w-12 h-12 rounded-full' alt="" />
