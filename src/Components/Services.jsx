...
const Services = () => {
    ...
    const servicesData = [
        {
            title: 'Advertising',
            description: 'We turn bold ideas into powerful digital soulutions that connect, engage...',
  ...
  return (
    ...
    dark:text-white'>
        ...
        to execution, we craft digital solutions that move your
        business forward.' />

        <div className='flex flex-col md:grid grid-cols-2 items-center'>
