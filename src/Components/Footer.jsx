...
const Footer = ({theme , setTheme}) => {
  return (
    ...
    sm:pt-20 mt-20 sm:mt-40 px-4 sm:px-10 lg-px-24 xl:px-40'>
      
      {/* footer top (which has two left and right parts itself) */}
      <div className='flex justify-between lg:items-center
        ...
        className='text-gray-600 dark:text-gray-400'>
            ...
            <div className='flex gap-2 text-sm'>
                ...
                px-6' onClick={()=>{toast.success('Thanks for your subscription')}}>Subscribe</button>
            </div>
        </motion.div>
      ...
      justify-center sm:justify-between gap-4 flex-wrap'>
        ...
        <div className='flex items-center justify-between gap-4'>
            <img className='w-6' src={assets.facebook_icon} alt="" />
            <img className='w-6' src={assets.twitter_icon} alt="" />
            <img className='w-6' src={assets.instagram_icon} alt="" />
            <img className='w-6' src={assets.linkedin_icon} alt="" />
        </div>
      </motion.div>
